  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Milk",style: TextStyle(
          color: Colors.white,
                      ...
                      children: [
                        Expanded(
                            ...
                            child: Container(
                              ...
                              height: 200,
                              child: Image.network("https://static5.depositphotos.com/1020804/534/i/450/depositphotos_5347226-stock-photo-splash-of-milk.jpg",
                                fit: BoxFit.cover,width: 200,height: double.infinity,),
                            )),
                        Expanded(
                            flex: 1,
                            child: Container(
